 ...
 * You can no longer create your own instances of `JavaPluginConvention`, `ApplicationPluginConvention`, `WarPluginConvention`, link:{javadocPath}/org/gradle/plugins/ear/EarPluginConvention.html[EarPluginConvention], `BasePluginConvention`, and `ProjectReportsPluginConvention`.
